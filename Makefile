...
realtimesolver_mpi: src/realtimesolver.c Makefile
	$(MPICC) $(CF) $(I) -o realtimesolver.o  src/multipleshooting.c src/cost.c src/lagrange.c src/realtimesolver.c src/constraints.c src/riccati.c src/solver.c src/alloc_mem.c src/gen.c src/config.c src/diff.c src/calc_time.c src/nrm.c src/output.c src/rtopt_gen.c src/dyn.c src/cs_ext.c src/test.c $(CS)	
